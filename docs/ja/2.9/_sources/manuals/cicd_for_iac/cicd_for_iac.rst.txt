...
2. | リモートリポジトリ画面の入力項目は以下の通りです。
   ...
   .. table:: リモートリポジトリ画面 入力項目一覧
      ...
      |      |        |                                  |          |               |                 |
      |      |        | プロキシサーバの URL が `http://\|          |               |                 |
      |      |        | proxy.gate.co.jp:8080` の場合    |          |               |                 |
      |      |        |                                  |          |               |                 |
      |      |        | Address には `http://proxy.gate.\|          |               |                 |
      |      |        | co.jp` を入力します。            |          |               |                 |
      |      |        |                                  |          |               |                 |
      |      |        | Port には 8080 を入力します。    |          |               |                 |
      |      +--------+----------------------------------+----------+---------------+-----------------+
...
2. | 資材紐付画面の入力項目は以下の通りです。
   ...
   .. table:: 資材紐付画面 入力項目一覧
      ...
      |               | | メニュー名           | 項目名            |      |          |               |                 |
      |               | +======================+===================+      |          |               |                 |
      |               | | Ansible-Legacy/Play\ | Playbook 素材名   |      |          |               |                 |
      |               | | book 素材集          |                   |      |          |               |                 |
      |               | +----------------------+-------------------+      |          |               |                 |
...
3. | Gitリポジトリの資材と紐付先資材との同期の状態を表示する項目は以下の通りです。
   ...
   .. table:: 資材紐付画面 状態表示項目一覧
      ...
      |      |                  | ると詳細情報はクリアされます。                    |             |
      |      +------------------+---------------------------------------------------+-------------+
      |      | 作業インスタン\  | オペレーションと Movement で作業実行が実行できた\ |             |
      |      | スNo             | 場合、作業実行の作業インスタンス No が表示されま\ |             |
      |      |                  | す。                                              |             |
      |      |                  |                                                   |             |
      |      |                  | 再開ボタンをクリックするか、該当レコードを更新す\ |             |
