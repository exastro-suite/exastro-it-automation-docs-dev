...
#. | Maintains (view.register/edit/discard) Movement information.
   ...
   .. figure:: /images/ja/ansible-legacy/movement_list/movement_list_v2_5.png
      :width: 800px
...
#. | Press the :guilabel:`Register` button to register Movement information.
   ...
   .. figure:: /images/ja/ansible-legacy/movement_list/registration_movement_list_v2_5.gif
      :width: 800px
...
.. figure:: /images/ja/ansible-legacy/execution/execution_screen_v2_5.gif
   :width: 800px
   :alt: Execute menu
...
.. figure:: /images/ja/ansible-legacy/work_management/execution_list_v2_5.png
   :width: 800px
...
#. | The items found in the page are as following.
   ...
   .. table:: View page item list (Execution management) 
      ...
      |                                                                               | n from the :menuselection:`Ansible-Legacy --> Execution status check` menu.\ |
      |                                                                               | or not.                                                                      |
      +-------------------------------------------------------------------------------+------------------------------------------------------------------------------+
