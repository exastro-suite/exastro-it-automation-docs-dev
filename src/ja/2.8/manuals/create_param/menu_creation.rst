...
.. tip:: | **代入値自動登録設定の連携対象項目について**
 | Ansibleドライバでは「文字列（単一行）」、「文字列（複数行）」、「整数」、「小数」、「パスワード」、「リンク」、「ファイルアップロード」が連携されます。
 | 「日時」、「日付」、および「プルダウン選択」で「日時」、「日付」を選んだ場合は連携されません。
 | Terraformドライバでは「文字列（単一行）」、「文字列（複数行）」、「整数」、「小数」、「パスワード」、「リンク」が連携されます。
 | 「日時」、「日付」、「ファイルアップロード」、および「プルダウン選択」で「日時」、「日付」を選んだ場合は連携されません。
