...
| 「期間延長あり」では、グルーピングされるイベントが発生するたびに先頭イベントのTTLが延長されます。
| 「期間延長なし」では、先頭イベントのTTL内、または個別に指定した期間内でグルーピングが行われます。
...
| グルーピング（期間延長あり／期間延長なし）それぞれのイメージは以下です。

.. figure:: /images/ja/oase/oase/filter_grouping_image.svg
   :width: 900px
...
.. figure:: /images/ja/oase/oase/filter_create_menu_v2-8.png
   :width: 800px
   :alt: フィルター画面
